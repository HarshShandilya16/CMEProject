...
def calculate_key_levels(db: Session, symbol: str) -> dict:
    ...
    try:
        ...
        # 2. Find Max OI Call Strike (Resistance)
        ...
        # 3. Find Max OI Put Strike (Support)
        ...
        return {
            ...
            "total_call_oi": int(total_calls_oi), # <-- NEW LINE
            "total_put_oi": int(total_puts_oi)    # <-- NEW LINE
        }
        ...
        return {
            ...
            "total_call_oi": 0, # <-- NEW LINE
            "total_put_oi": 0     # <-- NEW LINE
        }
